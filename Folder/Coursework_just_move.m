...
write1ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, PROFILE_VELOCITY, 3);
write1ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, PROFILE_VELOCITY, 3);
write1ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, PROFILE_VELOCITY, 3);
write1ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, PROFILE_VELOCITY, 3);
write1ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID5, PROFILE_VELOCITY, 3);
...
% % HAND
% write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID5, ADDR_PRO_GOAL_POSITION, 2000);
% pause(2);
% % WRIST
% write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID4, ADDR_PRO_GOAL_POSITION, 2000);
% pause(2);
% % ELBOW
% write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID3, ADDR_PRO_GOAL_POSITION, 2000);
% pause(2);
% SHOULDER
write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, ADDR_PRO_GOAL_POSITION, 2000);
pause(2);
% % BASE
% write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, ADDR_PRO_GOAL_POSITION, 2000);
% pause(2);
% -------------- MOVEMENT END----------
