classdef NewCubeController
    properties
        ...
        grip_vertical = -pi/2;
        UP_level_vert = 15 %8
        DOWN_level_hor = 3.9%2A 3.8%FLIPPING 3.5 %2C 3.2
        UP_level = 15 %5
    ...
    methods
        ...
        function main_cube_higher(obj,cube_pos_grid, final_pos_grid, flip_angle)
            %***INPUTS****% 
            % cube pos, final pos = x,y in grid coords
            % flip angle = angle diff in rad (inwards from top) 
            % append height and angle to cube and final pos
...
%             obj.robotController.move_to_positions(pos_array);
        ...
        function reach_move_flip_higher(obj,cube_pos, final_pos, gripper_initial_angle, gripper_final_angle)
...
%             obj.robotController.move_to_positions(pos_array);
        ...
        function reach_move_flip_noup(obj,cube_pos, final_pos, gripper_initial_angle, gripper_final_angle)
              ...
              %adjustment of scentrato 
                for i=1:turn
                    ...
                    if gripper_final_angle == obj.grip_vertical
                        ...
                        if norm(position) > 21.3
                            obj.robotController.move_to_positions([[position(1), position(2), DOWN+0.1, gripper_final_angle]]);
                            obj.close_gripper(); 
                        else
                            obj.robotController.move_to_positions([[position(1)+vec(1), position(2)+vec(2), DOWN+0.1, gripper_final_angle]]);
                            obj.close_gripper(); 
                        end
                    ...
                    if gripper_final_angle == obj.grip_vertical
                        ...
                        obj.robotController.move_to_positions(pos);
                        obj.robotController.move_to_positions(obj.robotController.trajectory_angle(pos_current,[position(1)+vec(1), position(2)+vec(2), obj.UP_level,obj.grip_outwards ]));
                        ...
                        obj.open_gripper();
                        obj.robotController.move_to_positions([[position(1)+vec(1), position(2)+vec(2), obj.UP_level,obj.grip_outwards ]]);
...
%             obj.robotController.move_to_positions(pos_array);
        ...
        function flip_7_7_270(obj)
            position = [7*2.5,-7*2.5];
            DOWN = obj.DOWN_level_hor;
            gripper_final_angle = 0.02;
            current = obj.robotController.get_current_position();
            obj.robotController.move_to_positions_no_correct([[position(1), position(2), obj.UP_level, current(4)]]);
        ...
        function flip_72_270(obj)
            position = [7*2.5,2*2.5];
            DOWN = obj.DOWN_level_hor+1.5;
            gripper_final_angle = 0.02;
            current = obj.robotController.get_current_position();
            obj.robotController.move_to_positions_no_correct([[position(1), position(2), obj.UP_level, current(4)]]);
            pos = obj.robotController.trajectory_angle([position(1), position(2), obj.UP_level, current(4)],[position(1), position(2), obj.UP_level, gripper_final_angle]);
...
%             obj.robotController.move_to_positions([[position(1)+vec(1), position(2)+vec(2), DOWN+0.6, gripper_final_angle]]);
        ...
        function flip_07_90(obj)
            position = [0*2.5,7*2.5];
            DOWN = obj.DOWN_level_vert+0.5;
            gripper_final_angle = -pi/2;
            current = obj.robotController.get_current_position();
                        obj.robotController.move_to_positions_no_correct([[position(1), position(2), obj.UP_level, current(4)]]);
            pos = obj.robotController.trajectory_angle([position(1), position(2), obj.UP_level, current(4)],[position(1), position(2), obj.UP_level, gripper_final_angle]);
            ...
            obj.close_gripper();
            obj.robotController.move_to_positions_no_correct([[position(1), position(2), obj.UP_level, gripper_final_angle]]);
            vec = position / norm(position) * -0.3; 
            angle_off = 0
            down_off = 1.5;
            pos_current = [position(1)+vec(1), position(2)+vec(2), obj.UP_level, gripper_final_angle]
            pos = obj.robotController.trajectory_angle(pos_current,[pos_current(1)+vec(1), pos_current(2)+vec(2), pos_current(3),  obj.grip_vertical]);
